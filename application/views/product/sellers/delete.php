...
if (isset($mapping_id)) {
    ...
    <form action="<?php echo URL_X . 'Product_seller_mapping/delete/' . $mapping_id; ?>" method="POST">
...
<!--            line below means in product seller mapping get all the 
            ...
            <a href="<?php echo URL_X . 'Product_seller_mapping/sellers/'.$product_id; ?>" class="btn btn-primary">Cancel</a>
        </p>
    </form>
